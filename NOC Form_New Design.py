...
BOOLEAN_FIELDS = {
    ...
    "issue_biological_resources", "issue_coastal_zone", "issue_Cultural_Resources", "issue_cumulative_effects",
...
def load_presets():
    ...
    candidate_paths = [os.path.join(base_dir, "project_data1.csv")]
...
if st.button("Test ODS values"):
    import pandas as pd
    try:
        df = pd.read_csv("project_data1.csv", dtype=object)
...
# Accessible header — logo first (aligned right), then title (outside any table)
...
# --- start DATE FIELD next to signature ---
